...
public class CrearArbol extends javax.swing.JFrame {
    ...
    /*
    public boolean existeNodo(ArrayList<NodoN> nod, NodoN pos){
        for(NodoN k: nod){
            if(k.getDato().equals(pos.getDato())){
            return true;
        }
        }
        return false;
    ...
    */
    ...
    public void iniciarArbol(ArrayList<ArrayList> elementos){
        ...
        //ArrayList<NodoN> nod = new ArrayList<>();
    ...
    public void generarArbol(ArbolB bin){
        //arb.print(arb.getRaiz(), this.TxtTree);B
        BTreeView btv = new BTreeView(arb);
        btv.setVisible(true);
    }
    ...
    public void distanciaMinima(ArrayList<NodoN> vec){
        ...
        this.LblMenor.setText("El Nodo con la menor distancia a la raíz es: "+minValue.getDato().toString()+", con una distancia de: " +
                Integer.toString(minValue.getDistancia()));
    }
    ...
    private void initComponents() {
        ...
        LblMenor.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        LblMenor.setForeground(new java.awt.Color(255, 0, 0));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(LblMenor, javax.swing.GroupLayout.DEFAULT_SIZE, 24, Short.MAX_VALUE)
                .addContainerGap())
        );
