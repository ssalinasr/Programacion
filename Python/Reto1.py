...
'''
Cada alineación, corresponde a cada posible movimiento de las cadenas:
    movimiento cadena 1
    movimiento cadena 2
    movimiento cadena 3
    movimiento cadena 1 y 3
    movimiento cadena 1 y 2
    movimiento cadena 2 y 3
    ningún movimiento
'''
alineacion_1M_2N_3N = []
alineacion_1N_2M_3N = []
...
print("La cantidad de alineaciones en esta seleccion es: "+str(max_value))
print(" ")
print(str_final1)
print(str_final2)
print(str_final3)
