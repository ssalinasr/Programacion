...
public class vectornotas
{
   ...
   throws IOException
  {
   ...
   temp=0;
   System.out.println("VECTOR NOTAS ENTRE 3 Y 3.5");
   for(a=0;a<=19;a++)
   {
   ...
   prom1=acum1/cont1;
    ...
    System.out.println("El promedio de las notas entre 3 y 3.5 es: \t "+prom1);
      System.out.println("\n");
     System.out.println("VECTOR NOTAS ENTRE 3.6 Y 4");
   for(a=0;a<=19;a++)
   {
   ...
   System.out.println("VECTOR NOTAS MENORES QUE 3");
   for(a=0;a<=19;a++)
   {
   ...
   prom3=acum3/cont3;
    ...
    System.out.println("VECTOR NOTAS MAYORES A 4");
   for(a=0;a<=19;a++)
   {
